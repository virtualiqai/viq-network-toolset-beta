...
This is a plain-English summary of how you may use Virtual IQ AI NetOps Toolset (also distributed as **VIQ Engineer Toolset**). The formal legal agreement is in [LICENSE](./LICENSE). If anything here conflicts with the LICENSE, the LICENSE controls.
